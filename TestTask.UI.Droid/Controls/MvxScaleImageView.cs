...
namespace TestTask.UI.Droid.Controls
{
	...
	public class RotateListener : RotateGestureDetector.SimpleOnRotateGestureListener {
	...
	public class MoveListener : MoveGestureDetector.SimpleOnMoveGestureListener {
	...
	public class ScaleImageView : MvxImageView, View.IOnTouchListener
	{
		...
		private GestureDetector m_ScaleGestureDetector;
		private RotateGestureDetector m_RotateGestureDetector;
		private MoveGestureDetector m_MoveGestureDetector;
		...
		private void Initialize()
		{
			...
			m_ScaleGestureDetector = new GestureDetector(m_Context, new ScaleImageViewGestureDetector(this));
			m_RotateGestureDetector = new RotateGestureDetector(m_Context, new RotateListener());
			m_MoveGestureDetector = new MoveGestureDetector(m_Context, new MoveListener());
		}
		...
		{
			m_RotateGestureDetector.OnTouchEvent (e);
			m_MoveGestureDetector.OnTouchEvent (e);
			if (m_ScaleGestureDetector.OnTouchEvent(e))
			{
